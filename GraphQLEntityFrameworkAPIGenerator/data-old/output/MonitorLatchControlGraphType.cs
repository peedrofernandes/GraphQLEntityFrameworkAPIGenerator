...
{
    public partial class MonitorLatchControlGraphType : ObjectGraphType<MonitorLatchControl>
    {
        public MonitorLatchControlGraphType(GESECookingContext dbContext, IDataLoaderContextAccessor dataLoaderAccessor)
        {
            Field(t => t.LatchControlId, type: typeof(GuidGraphType), nullable: False);
			Field(t => t.Version, type: typeof(ByteGraphType), nullable: False);
			Field(t => t.LatchDriveTime, type: typeof(FloatGraphType), nullable: False);
			Field(t => t.LatchOverdriveTime, type: typeof(FloatGraphType), nullable: False);
                ...
                Field<MachineConfigurationGraphType, MachineConfiguration>("MachineConfigurations")
                    .ResolveAsync(context => 
                    {
                        var loader = dataLoaderAccessor.Context.GetOrAddCollectionBatchLoader<Guid, IEnumerable<MachineConfigurationGraphType>>(
                            "{ Name = EntityName "MonitorLatchControl"
  CorrespondingTable =
   Regular
     { Name = TableName "MonitorLatchControl"
       Properties =
  ...
  Fields =
   [{ Name = "LatchControlId"
      ...
      IsNullable = false }; { Name = "Version"
                              Type = Primitive Byte
                              IsNullable = false }; { Name = "LatchDriveTime"
