                ...
                Field<TableTargetGraphType, TableTarget>("TableTargets")
                    .ResolveAsync(context => 
                    {
                        var loader = dataLoaderAccessor.Context.GetOrAddCollectionBatchLoader<byte, TableTargetGraphType>(
                            "{ Name = EntityName "PilotGeneralizedProfile"
  CorrespondingTable =
   Regular
     { Name = TableName "PilotGeneralizedProfile"
       Properties =
   ...
   [{ Name = "Id"
    ...
    { Name = "Owner"
      ...
      IsNullable = false }; { Name = "Timestamp"
                              ...
                              IsNullable = false }; { Name = "Nperiods"
                                                      Type = Primitive Byte
                                                      IsNullable = false };
    { Name = "StartFromNegative"
      Type = Primitive Bool
      IsNullable = false }; { Name = "Compensated"
                              Type = Primitive Bool
