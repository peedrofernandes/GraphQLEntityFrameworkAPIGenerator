...
{
    public partial class EepromEndStateUicycleViewGraphType : ObjectGraphType<EepromEndStateUicycleView>
    {
        public EepromEndStateUicycleViewGraphType(GESECookingContext dbContext, IDataLoaderContextAccessor dataLoaderAccessor)
        {
