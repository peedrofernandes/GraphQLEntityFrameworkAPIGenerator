...
{
    public partial class IpcControllerConfigurationsIpcControllerIpcConfigurationGraphType : ObjectGraphType<IpcControllerConfigurationsIpcControllerIpcConfiguration>
    {
        public IpcControllerConfigurationsIpcControllerIpcConfigurationGraphType(GESECookingContext dbContext, IDataLoaderContextAccessor dataLoaderAccessor)
        {
                ...
                Field<IpcControllerConfigurationGraphType, IpcControllerConfiguration>("IpcControllerConfigurations")
                    .ResolveAsync(context => 
                    {
                        var loader = dataLoaderAccessor.Context.GetOrAddCollectionBatchLoader<Guid, IpcControllerConfigurationGraphType>(
                            "{ Name = EntityName "IpcControllerConfigurationsIpcControllerIpcConfiguration"
  CorrespondingTable =
   Regular
     { Name =
  ...
  Fields =
   [{ Name = "IpcControllerConfigurationsId"
      Type = Id Guid
      IsNullable = false }; { Name = "IpcControllerIpcConfigurationsId"
                              Type = Id Guid
  ...
  Relations =
   [SingleManyToOne
      { Name = RelationName "IpcControllerConfiguration"
        TargetTable =
         { Name = TableName "IpcControllerConfiguration"
           Properties =
            [PrimaryKey { Type = Guid
                          Name = "IpcControllerConfigurationsId"
             ...
             Navigation { Type = TableName "MachineConfiguration"
                          ...
                          IsNullable = false
                          IsCollection = true }] }
        Destination = EntityName "IpcControllerConfiguration"
        IsNullable = false
        KeyType = Guid };
    SingleManyToOne
      { Name = RelationName "IpcControllerIpcConfiguration"
        ...
        IsNullable = false
        KeyType = Guid }] }-IpcControllerConfiguration-loader",
                            async ids => 
                            {
