...
{
    public partial class MonitorMultiPointProbeGraphType : ObjectGraphType<MonitorMultiPointProbe>
    {
        public MonitorMultiPointProbeGraphType(GESECookingContext dbContext, IDataLoaderContextAccessor dataLoaderAccessor)
        {
			...
			Field(t => t.ParabolicFilterParameter, type: typeof(FloatGraphType), nullable: False);
                ...
                Field<MachineConfigurationGraphType, MachineConfiguration>("MachineConfigurations")
                    .ResolveAsync(context => 
                    {
                        var loader = dataLoaderAccessor.Context.GetOrAddCollectionBatchLoader<Guid, IEnumerable<MachineConfigurationGraphType>>(
                            "{ Name = EntityName "MonitorMultiPointProbe"
  CorrespondingTable =
   Regular
     { Name = TableName "MonitorMultiPointProbe"
       Properties =
  ...
  Fields =
   [{ Name = "Id"
    ...
    { Name = "Version"
      Type = Primitive Byte
      IsNullable = false }; { Name = "ParabolicFilterParameter"
