...
namespace WP.Cooking.GESE.WebAPI.GraphQL.Types
{
                ...
                Field<SrsafetyRelevantParameterGraphType, SrsafetyRelevantParameter>("SrsafetyRelevantParameters")
                    .ResolveAsync(context => 
                    {
                        var loader = dataLoaderAccessor.Context.GetOrAddCollectionBatchLoader<Guid, IEnumerable<SrsafetyRelevantParameterGraphType>>(
                            "{ Name = EntityName "SroverTempCheckParameter"
  CorrespondingTable =
   Regular
  ...
  Fields =
   [{ Name = "Id"
    ...
    { Name = "Version"
      Type = Primitive Byte
      IsNullable = true }; { Name = "Tiai"
                             Type = Primitive Byte
                             IsNullable = false };
    { Name = "Rtd1disableLatchThreshold"
      Type = Primitive Short
      IsNullable = false }; { Name = "Rtd1disableLoadsNormalThreshold"
                              Type = Primitive Short
                              IsNullable = false };
    { Name = "Rtd1disableLoadsCleanThreshold"
      Type = Primitive Short
      IsNullable = false }; { Name = "Rtd2disableLatchThreshold"
                              Type = Primitive Short
                              IsNullable = false };
    { Name = "Rtd2disableLoadsNormalThreshold"
      Type = Primitive Short
      IsNullable = false }; { Name = "Rtd2disableLoadsCleanThreshold"
                              Type = Primitive Short
                              IsNullable = false };
    { Name = "Rtd1shortedSensorThreshold"
      Type = Primitive Short
      IsNullable = false }; { Name = "Rtd1openedSensorThreshold"
                              Type = Primitive Short
                              IsNullable = false };
    { Name = "Rtd2shortedSensorThreshold"
      Type = Primitive Short
      IsNullable = false }; { Name = "Rtd2openedSensorThreshold"
                              Type = Primitive Short
                              IsNullable = false }]
  Relations =
   [OneToMany
