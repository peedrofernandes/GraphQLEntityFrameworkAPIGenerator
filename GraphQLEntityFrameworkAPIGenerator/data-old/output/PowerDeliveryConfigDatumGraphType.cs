...
{
    public partial class PowerDeliveryConfigDatumGraphType : ObjectGraphType<PowerDeliveryConfigDatum>
    {
        public PowerDeliveryConfigDatumGraphType(GESECookingContext dbContext, IDataLoaderContextAccessor dataLoaderAccessor)
        {
            Field(t => t.PowerDeliveryConfigId, type: typeof(GuidGraphType), nullable: False);
			...
			Field(t => t.MaxPowerGainFactorForPasoDobleOptimizer, type: typeof(FloatGraphType), nullable: False);
			Field(t => t.LoadCharacterizationAttemptWaitingTime, type: typeof(IdGraphType), nullable: False);
                ...
                Field<IpcControllerIpcConfigurationGraphType, IpcControllerIpcConfiguration>("IpcControllerIpcConfigurations")
                    .ResolveAsync(context => 
                    {
                        var loader = dataLoaderAccessor.Context.GetOrAddCollectionBatchLoader<Guid, IEnumerable<IpcControllerIpcConfigurationGraphType>>(
                            "{ Name = EntityName "PowerDeliveryConfigDatum"
  CorrespondingTable =
   Regular
  ...
  Fields =
   [{ Name = "PowerDeliveryConfigId"
    ...
    { Name = "MaxPowerGainFactorForPasoDobleOptimizer"
      ...
      IsNullable = false }; { Name = "LoadCharacterizationAttemptWaitingTime"
                              Type = Primitive Int
                              IsNullable = false }]
  Relations =
   [OneToMany
