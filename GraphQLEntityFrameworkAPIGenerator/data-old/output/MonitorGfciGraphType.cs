...
{
    public partial class MonitorGfciGraphType : ObjectGraphType<MonitorGfci>
    {
        public MonitorGfciGraphType(GESECookingContext dbContext, IDataLoaderContextAccessor dataLoaderAccessor)
        {
            Field(t => t.MonitorGfciId, type: typeof(GuidGraphType), nullable: False);
			...
			Field(t => t.IdleTimeThreshold, type: typeof(IdGraphType), nullable: False);
			Field(t => t.HeaterOnTime, type: typeof(IdGraphType), nullable: False);
			Field(t => t.HeaterOffTime, type: typeof(IdGraphType), nullable: False);
			Field(t => t.PwmTime, type: typeof(IdGraphType), nullable: False);
                ...
                Field<MachineConfigurationGraphType, MachineConfiguration>("MachineConfigurations")
                    .ResolveAsync(context => 
                    {
                        var loader = dataLoaderAccessor.Context.GetOrAddCollectionBatchLoader<Guid, IEnumerable<MachineConfigurationGraphType>>(
                            "{ Name = EntityName "MonitorGfci"
  CorrespondingTable =
   Regular
     { Name = TableName "MonitorGfci"
       Properties =
  ...
  Fields =
   [{ Name = "MonitorGfciId"
    ...
    { Name = "Version"
      Type = Primitive Byte
      IsNullable = false }; { Name = "IdleTimeThreshold"
                              Type = Primitive Int
                              IsNullable = false }; { Name = "HeaterOnTime"
                                                      Type = Primitive Int
                                                      IsNullable = false };
    { Name = "HeaterOffTime"
      Type = Primitive Int
      IsNullable = false }; { Name = "PwmTime"
                              Type = Primitive Int
                              IsNullable = false }]
  Relations =
   [OneToMany
