...
{
    public partial class EepromOffselectorViewGraphType : ObjectGraphType<EepromOffselectorView>
    {
        public EepromOffselectorViewGraphType(GESECookingContext dbContext, IDataLoaderContextAccessor dataLoaderAccessor)
        {
