...
{
    public partial class EepromUiselectorViewGraphType : ObjectGraphType<EepromUiselectorView>
    {
        public EepromUiselectorViewGraphType(GESECookingContext dbContext, IDataLoaderContextAccessor dataLoaderAccessor)
        {
