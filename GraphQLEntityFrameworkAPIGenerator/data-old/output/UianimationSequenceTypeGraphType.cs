...
{
    public partial class UianimationSequenceTypeGraphType : ObjectGraphType<UianimationSequenceType>
    {
        public UianimationSequenceTypeGraphType(GESECookingContext dbContext, IDataLoaderContextAccessor dataLoaderAccessor)
        {
			...
			Field(t => t.StepNumber, type: typeof(ByteGraphType), nullable: False);
			Field(t => t.TailScalingNumber, type: typeof(ByteGraphType), nullable: False);
			Field(t => t.TailStepNumber, type: typeof(ByteGraphType), nullable: False);
                ...
                Field<UianimationDetailGraphType, UianimationDetail>("UianimationDetails")
                    .ResolveAsync(context => 
                    {
                        var loader = dataLoaderAccessor.Context.GetOrAddCollectionBatchLoader<Guid, IEnumerable<UianimationDetailGraphType>>(
                            "{ Name = EntityName "UianimationSequenceType"
  CorrespondingTable =
   Regular
  ...
  Fields =
   [{ Name = "Id"
    ...
    { Name = "StepNumber"
      Type = Primitive Byte
      IsNullable = false }; { Name = "TailScalingNumber"
                              Type = Primitive Byte
                              IsNullable = false }; { Name = "TailStepNumber"
                                                      Type = Primitive Byte
                                                      IsNullable = false }]
  Relations =
   [OneToMany
