                ...
                Field<TableTargetGraphType, TableTarget>("TableTargets")
                    .ResolveAsync(context => 
                    {
                        var loader = dataLoaderAccessor.Context.GetOrAddCollectionBatchLoader<byte, TableTargetGraphType>(
                            "{ Name = EntityName "UiprmGidiscretePotentiometer"
  CorrespondingTable =
   Regular
     { Name = TableName "UiprmGidiscretePotentiometer"
       Properties =
  ...
  Fields =
   [{ Name = "Id"
      ...
      IsNullable = false }; { Name = "Description"
                              ...
                              IsNullable = false }; { Name = "RegulationNum"
                                                      Type = Primitive Byte
                                                      IsNullable = false };
    { Name = "Size"
      Type = Primitive Bool
      IsNullable = false }; { Name = "Hysteresis"
                              Type = Primitive Byte
                              IsNullable = false };
    { Name = "EnableRangeDetection"
      Type = Primitive Bool
