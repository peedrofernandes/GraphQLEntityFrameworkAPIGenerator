...
{
    public partial class EepromStateUiselectorViewGraphType : ObjectGraphType<EepromStateUiselectorView>
    {
        public EepromStateUiselectorViewGraphType(GESECookingContext dbContext, IDataLoaderContextAccessor dataLoaderAccessor)
        {
			...
			Field(t => t.CyclePosition, type: typeof(IdGraphType), nullable: False);
			...
			Field(t => t.UistatementId, type: typeof(GuidGraphType), nullable: True);
