...
{
    public partial class MonitorWarmingZoneGraphType : ObjectGraphType<MonitorWarmingZone>
    {
        public MonitorWarmingZoneGraphType(GESECookingContext dbContext, IDataLoaderContextAccessor dataLoaderAccessor)
        {
            Field(t => t.WarmingZoneParamsId, type: typeof(GuidGraphType), nullable: False);
                ...
                Field<MachineConfigurationGraphType, MachineConfiguration>("MachineConfigurations")
                    .ResolveAsync(context => 
                    {
                        var loader = dataLoaderAccessor.Context.GetOrAddCollectionBatchLoader<Guid, IEnumerable<MachineConfigurationGraphType>>(
                            "{ Name = EntityName "MonitorWarmingZone"
  CorrespondingTable =
   Regular
     { Name = TableName "MonitorWarmingZone"
       Properties =
   ...
   [{ Name = "WarmingZoneParamsId"
    ...
    { Name = "Version"
      ...
      IsNullable = false }; { Name = "DutyPeriod"
                              Type = Primitive Byte
                              IsNullable = false }; { Name = "StartTime"
                                                      Type = Primitive Byte
                                                      IsNullable = false };
    { Name = "StopTime"
      Type = Primitive Byte
