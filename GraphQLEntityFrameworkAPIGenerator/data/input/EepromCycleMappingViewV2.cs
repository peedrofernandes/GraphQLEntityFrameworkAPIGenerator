...
[Keyless]
public partial class EepromCycleMappingViewV2
{
    ...
    [StringLength(50)]
    [Unicode(false)]
    public string? CycleMappingProductVariantDescription { get; set; }

    public byte? CycleMappingProductVariantId { get; set; }
}
