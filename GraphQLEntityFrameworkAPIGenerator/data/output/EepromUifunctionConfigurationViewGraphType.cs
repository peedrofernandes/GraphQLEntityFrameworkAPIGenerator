...
{
    public partial class EepromUifunctionConfigurationViewGraphType : ObjectGraphType<EepromUifunctionConfigurationView>
    {
        public EepromUifunctionConfigurationViewGraphType(GESECookingContext dbContext, IDataLoaderContextAccessor dataLoaderAccessor)
        {
			...
			Field(t => t.IsFunctionLabelNotNull, type: typeof(IdGraphType), nullable: False);
			Field(t => t.FactoryRestoreIndex, type: typeof(ByteGraphType), nullable: False);
			Field(t => t.RegulationNum, type: typeof(ByteGraphType), nullable: True);
