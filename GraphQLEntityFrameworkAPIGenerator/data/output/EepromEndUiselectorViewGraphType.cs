...
{
    public partial class EepromEndUiselectorViewGraphType : ObjectGraphType<EepromEndUiselectorView>
    {
        public EepromEndUiselectorViewGraphType(GESECookingContext dbContext, IDataLoaderContextAccessor dataLoaderAccessor)
        {
