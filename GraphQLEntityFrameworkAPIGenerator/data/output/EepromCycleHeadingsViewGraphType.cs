...
{
    public partial class EepromCycleHeadingsViewGraphType : ObjectGraphType<EepromCycleHeadingsView>
    {
        public EepromCycleHeadingsViewGraphType(GESECookingContext dbContext, IDataLoaderContextAccessor dataLoaderAccessor)
        {
