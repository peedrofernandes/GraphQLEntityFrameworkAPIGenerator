...
{
    public partial class HmiexpansionBoardConfigurationsDisplayGraphType : ObjectGraphType<HmiexpansionBoardConfigurationsDisplay>
    {
        public HmiexpansionBoardConfigurationsDisplayGraphType(GESECookingContext dbContext, IDataLoaderContextAccessor dataLoaderAccessor)
        {
                ...
                Field<DisplayGraphType, Display>("Displays")
                    .ResolveAsync(context => 
                    {
                        var loader = dataLoaderAccessor.Context.GetOrAddCollectionBatchLoader<Guid, DisplayGraphType>(
                            "{ Name = EntityName "HmiexpansionBoardConfigurationsDisplay"
  CorrespondingTable =
   Regular
  ...
  Fields =
   [{ Name = "HmiexpansionBoardConfigurationId"
      Type = Id Guid
      IsNullable = false }; { Name = "DisplayId"
                              Type = Id Guid
  ...
  Relations =
   [SingleManyToOne
      { Name = RelationName "Display"
        ...
        KeyType = Guid };
    SingleManyToOne
      { Name = RelationName "HmiexpansionBoardConfiguration"
        TargetTable =
            ...
            [PrimaryKey { Type = Guid
             ...
             Navigation
               { Type = TableName "HmiexpansionBoardConfigurationsDisplay"
                 ...
                 IsNullable = false
                 IsCollection = true }] }
        Destination = EntityName "HmiexpansionBoardConfiguration"
        IsNullable = false
   ...
   [SingleManyToOne
    ...
    SingleManyToOne
      { Name = RelationName "HmiexpansionBoardConfiguration"
        ...
        Destination = EntityName "HmiexpansionBoardConfiguration"
        IsNullable = false
        KeyType = Guid }] }-HmiexpansionBoardConfiguration-loader",
                            async ids => 
                            {
