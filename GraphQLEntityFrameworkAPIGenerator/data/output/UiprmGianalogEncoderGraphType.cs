...
{
    public partial class UiprmGianalogEncoderGraphType : ObjectGraphType<UiprmGianalogEncoder>
    {
        public UiprmGianalogEncoderGraphType(GESECookingContext dbContext, IDataLoaderContextAccessor dataLoaderAccessor)
        {
            ...
            Field<TableTargetGraphType, TableTarget>("TableTargets")
                .ResolveAsync(context => 
                {
                    var loader = dataLoaderAccessor.Context.GetOrAddCollectionBatchLoader<byte, TableTargetGraphType>(
                        "UiprmGianalogEncoder-TableTarget-loader",
                        async ids => 
                        {
