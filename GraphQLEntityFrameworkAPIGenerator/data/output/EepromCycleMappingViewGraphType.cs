...
{
    public partial class EepromCycleMappingViewGraphType : ObjectGraphType<EepromCycleMappingView>
    {
        public EepromCycleMappingViewGraphType(GESECookingContext dbContext, IDataLoaderContextAccessor dataLoaderAccessor)
        {
			...
			Field(t => t.ExportOptionId, type: typeof(ByteGraphType), nullable: False);
			...
			Field(t => t.CycleNameId, type: typeof(IdGraphType), nullable: True);
			...
			Field(t => t.FileId, type: typeof(StringGraphType), nullable: True);
			Field(t => t.Revision, type: typeof(IdGraphType), nullable: False);
			Field(t => t.CycleMappingFileInfoId, type: typeof(GuidGraphType), nullable: True);
			Field(t => t.CycleMappingId, type: typeof(GuidGraphType), nullable: False);
			Field(t => t.UriTreeId, type: typeof(GuidGraphType), nullable: True);
