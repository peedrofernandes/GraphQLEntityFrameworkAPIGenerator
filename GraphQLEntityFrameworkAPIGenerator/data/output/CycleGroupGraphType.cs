...
{
    public partial class CycleGroupGraphType : ObjectGraphType<CycleGroup>
    {
        public CycleGroupGraphType(GESECookingContext dbContext, IDataLoaderContextAccessor dataLoaderAccessor)
        {
            Field(t => t.Id, type: typeof(ByteGraphType), nullable: False);
			Field(t => t.CycleGroup1, type: typeof(StringGraphType), nullable: False);
  ...
  Fields = [{ Name = "Id"
              Type = Id Byte
              IsNullable = false }; { Name = "CycleGroup1"
