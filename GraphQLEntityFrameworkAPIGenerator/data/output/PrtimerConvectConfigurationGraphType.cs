            ...
            Field<PowerReductionTimerConfigurationGraphType, PowerReductionTimerConfiguration>("PowerReductionTimerConfigurations")
                .ResolveAsync(context => 
                {
                    var loader = dataLoaderAccessor.Context.GetOrAddCollectionBatchLoader<Guid, IEnumerable<PowerReductionTimerConfigurationGraphType>>(
                        "PrtimerConvectConfiguration-PowerReductionTimerConfiguration-loader",
                        async ids => 
                        {
            ...
            Field<PrtimerConvectUserPhaseNameConfigurationGraphType, PrtimerConvectUserPhaseNameConfiguration>("PrtimerConvectUserPhaseNameConfigurations")
                .ResolveAsync(context => 
                {
                    var loader = dataLoaderAccessor.Context.GetOrAddCollectionBatchLoader<Guid, IEnumerable<PrtimerConvectUserPhaseNameConfigurationGraphType>>(
                        "PrtimerConvectConfiguration-PrtimerConvectUserPhaseNameConfiguration-loader",
                        async ids => 
                        {
            ...
            Field<PrtimerConvectTimerLimitConfigurationGraphType, PrtimerConvectTimerLimitConfiguration>("PrtimerConvectTimerLimitConfigurations")
                .ResolveAsync(context => 
                {
                    var loader = dataLoaderAccessor.Context.GetOrAddCollectionBatchLoader<Guid, PrtimerConvectTimerLimitConfigurationGraphType>(
                        "PrtimerConvectConfiguration-PrtimerConvectTimerLimitConfiguration-loader",
                        async ids => 
                        {
