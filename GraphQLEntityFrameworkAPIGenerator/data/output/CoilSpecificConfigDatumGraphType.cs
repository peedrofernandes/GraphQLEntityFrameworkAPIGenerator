...
{
    public partial class CoilSpecificConfigDatumGraphType : ObjectGraphType<CoilSpecificConfigDatum>
    {
        public CoilSpecificConfigDatumGraphType(GESECookingContext dbContext, IDataLoaderContextAccessor dataLoaderAccessor)
        {
            Field(t => t.CoilSpecificConfigId, type: typeof(GuidGraphType), nullable: False);
			...
			Field(t => t.MaxNominalDeliveryPower, type: typeof(FloatGraphType), nullable: False);
            ...
            Field<IpcControllerCoilDetailGraphType, IpcControllerCoilDetail>("IpcControllerCoilDetails")
                .ResolveAsync(context => 
                {
                    var loader = dataLoaderAccessor.Context.GetOrAddCollectionBatchLoader<Guid, IEnumerable<IpcControllerCoilDetailGraphType>>(
                        "CoilSpecificConfigDatum-IpcControllerCoilDetail-loader",
                        async ids => 
                        {
