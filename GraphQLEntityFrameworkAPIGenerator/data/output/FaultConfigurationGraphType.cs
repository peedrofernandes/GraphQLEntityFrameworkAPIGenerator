...
{
    public partial class FaultConfigurationGraphType : ObjectGraphType<FaultConfiguration>
    {
        public FaultConfigurationGraphType(GESECookingContext dbContext, IDataLoaderContextAccessor dataLoaderAccessor)
        {
                ...
                Field<FaultConfigurationsFaultDetailGraphType, FaultConfigurationsFaultDetail>("FaultConfigurationsFaultDetails")
                    .ResolveAsync(context => 
                    {
                        var loader = dataLoaderAccessor.Context.GetOrAddCollectionBatchLoader<Guid, IEnumerable<FaultConfigurationsFaultDetailGraphType>>(
                            "{ Name = EntityName "FaultConfiguration"
  CorrespondingTable =
   Regular
   ...
   [OneToMany
    ...
    OneToMany
      { Name = RelationName "MachineConfiguration"
        ...
        KeyType = Guid }] }-FaultConfigurationsFaultDetail-loader",
                            async ids => 
                            {
