...
{
    public partial class MinimumDcSupplyGraphType : ObjectGraphType<MinimumDcSupply>
    {
        public MinimumDcSupplyGraphType(GESECookingContext dbContext, IDataLoaderContextAccessor dataLoaderAccessor)
        {
            Field(t => t.MinimumDcSupplyId, type: typeof(GuidGraphType), nullable: False);
			...
			Field(t => t.R1resistance, type: typeof(LongGraphType), nullable: False);
			Field(t => t.R2resistance, type: typeof(LongGraphType), nullable: False);
			Field(t => t.MinDcSupply, type: typeof(FloatGraphType), nullable: False);
			Field(t => t.AclowerInputVoltage, type: typeof(ShortGraphType), nullable: False);
			Field(t => t.AcupperInputVoltage, type: typeof(ShortGraphType), nullable: False);
			Field(t => t.AcvoltageDebounceMilliseconds, type: typeof(IdGraphType), nullable: False);
                ...
                Field<MachineConfigurationGraphType, MachineConfiguration>("MachineConfigurations")
                    .ResolveAsync(context => 
                    {
                        var loader = dataLoaderAccessor.Context.GetOrAddCollectionBatchLoader<Guid, IEnumerable<MachineConfigurationGraphType>>(
                            "{ Name = EntityName "MinimumDcSupply"
  CorrespondingTable =
   Regular
     { Name = TableName "MinimumDcSupply"
       Properties =
        [PrimaryKey { Type = Guid
         ...
         Primitive { Type = Short
                     Name = "AclowerInputVoltage"
                     IsNullable = false };
         Primitive { Type = Short
                     Name = "AcupperInputVoltage"
                     IsNullable = false };
         Primitive { Type = Int
                     Name = "AcvoltageDebounceMilliseconds"
                     IsNullable = false };
  ...
  Fields =
   [{ Name = "MinimumDcSupplyId"
    ...
    { Name = "Version"
      Type = Primitive Byte
      IsNullable = false }; { Name = "R1resistance"
                              Type = Primitive Long
                              IsNullable = false }; { Name = "R2resistance"
                                                      Type = Primitive Long
                                                      IsNullable = false };
    { Name = "MinDcSupply"
      Type = Primitive Float
      IsNullable = false }; { Name = "AclowerInputVoltage"
                              Type = Primitive Short
                              IsNullable = false };
    { Name = "AcupperInputVoltage"
      Type = Primitive Short
      IsNullable = false }; { Name = "AcvoltageDebounceMilliseconds"
                              Type = Primitive Int
                              IsNullable = false }]
  Relations =
   [OneToMany
