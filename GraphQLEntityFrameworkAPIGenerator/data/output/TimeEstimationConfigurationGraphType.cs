...
{
    public partial class TimeEstimationConfigurationGraphType : ObjectGraphType<TimeEstimationConfiguration>
    {
        public TimeEstimationConfigurationGraphType(GESECookingContext dbContext, IDataLoaderContextAccessor dataLoaderAccessor)
        {
            ...
            Field<MachineConfigurationGraphType, MachineConfiguration>("MachineConfigurations")
                .ResolveAsync(context => 
                {
                    var loader = dataLoaderAccessor.Context.GetOrAddCollectionBatchLoader<Guid, IEnumerable<MachineConfigurationGraphType>>(
                        "TimeEstimationConfiguration-MachineConfiguration-loader",
                        async ids => 
                        {
            ...
            Field<TimeEstimationDetailGraphType, TimeEstimationDetail>("TimeEstimationDetails")
                .ResolveAsync(context => 
                {
                    var loader = dataLoaderAccessor.Context.GetOrAddCollectionBatchLoader<Guid, IEnumerable<TimeEstimationDetailGraphType>>(
                        "TimeEstimationConfiguration-TimeEstimationDetail-loader",
                        async ids => 
                        {
