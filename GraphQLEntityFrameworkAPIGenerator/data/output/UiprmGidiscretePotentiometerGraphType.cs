...
{
    public partial class UiprmGidiscretePotentiometerGraphType : ObjectGraphType<UiprmGidiscretePotentiometer>
    {
        public UiprmGidiscretePotentiometerGraphType(GESECookingContext dbContext, IDataLoaderContextAccessor dataLoaderAccessor)
        {
            Field(t => t.Id, type: typeof(GuidGraphType), nullable: False);
			Field(t => t.Description, type: typeof(StringGraphType), nullable: False);
			Field(t => t.RegulationNum, type: typeof(ByteGraphType), nullable: False);
			Field(t => t.Size, type: typeof(BoolGraphType), nullable: False);
			Field(t => t.Threshold, type: typeof(ListGraphType<ByteGraphType>), nullable: False);
			Field(t => t.RegulationValue, type: typeof(ListGraphType<ByteGraphType>), nullable: False);
            ...
            Field<TableTargetGraphType, TableTarget>("TableTargets")
                .ResolveAsync(context => 
                {
                    var loader = dataLoaderAccessor.Context.GetOrAddCollectionBatchLoader<byte, TableTargetGraphType>(
                        "UiprmGidiscretePotentiometer-TableTarget-loader",
                        async ids => 
                        {
