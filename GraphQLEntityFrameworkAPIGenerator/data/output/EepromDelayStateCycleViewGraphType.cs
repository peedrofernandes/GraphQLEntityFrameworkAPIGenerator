...
{
    public partial class EepromDelayStateCycleViewGraphType : ObjectGraphType<EepromDelayStateCycleView>
    {
        public EepromDelayStateCycleViewGraphType(GESECookingContext dbContext, IDataLoaderContextAccessor dataLoaderAccessor)
        {
