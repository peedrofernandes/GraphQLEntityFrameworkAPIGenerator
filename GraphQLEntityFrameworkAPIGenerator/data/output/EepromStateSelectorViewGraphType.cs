...
{
    public partial class EepromStateSelectorViewGraphType : ObjectGraphType<EepromStateSelectorView>
    {
        public EepromStateSelectorViewGraphType(GESECookingContext dbContext, IDataLoaderContextAccessor dataLoaderAccessor)
        {
