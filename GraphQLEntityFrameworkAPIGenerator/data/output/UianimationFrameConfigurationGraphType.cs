    ...
    public partial class UianimationFrameConfigurationGraphType : ObjectGraphType<UianimationFrameConfiguration>
    {
        public UianimationFrameConfigurationGraphType(GESECookingContext dbContext, IDataLoaderContextAccessor dataLoaderAccessor)
        {
            ...
            Field<UianimationDetailGraphType, UianimationDetail>("UianimationDetails")
                .ResolveAsync(context => 
                {
                    var loader = dataLoaderAccessor.Context.GetOrAddCollectionBatchLoader<Guid, IEnumerable<UianimationDetailGraphType>>(
                        "UianimationFrameConfiguration-UianimationDetail-loader",
                        async ids => 
                        {
            ...
            Field<UianimationFrameDetailGraphType, UianimationFrameDetail>("UianimationFrameDetails")
                .ResolveAsync(context => 
                {
                    var loader = dataLoaderAccessor.Context.GetOrAddCollectionBatchLoader<Guid, IEnumerable<UianimationFrameDetailGraphType>>(
                        "UianimationFrameConfiguration-UianimationFrameDetail-loader",
                        async ids => 
                        {
                            var data = await dbContext.UianimationFrameConfigurationsUianimationFrameDetail
                                ...
                                .Select(x => new
                                {
                                    ...
                                    Value = x.UianimationFrameDetails,
                                })
                                .ToListAsync();
                    ...
                    return loader.LoadAsync(context.Source.UianimationFrameDetails);
                });
