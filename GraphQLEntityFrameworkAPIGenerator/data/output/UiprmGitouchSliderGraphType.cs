...
{
    public partial class UiprmGitouchSliderGraphType : ObjectGraphType<UiprmGitouchSlider>
    {
        public UiprmGitouchSliderGraphType(GESECookingContext dbContext, IDataLoaderContextAccessor dataLoaderAccessor)
        {
                ...
                Field<TableTargetGraphType, TableTarget>("TableTargets")
                    .ResolveAsync(context => 
                    {
                        var loader = dataLoaderAccessor.Context.GetOrAddCollectionBatchLoader<byte, TableTargetGraphType>(
                            "{ Name = EntityName "UiprmGitouchSlider"
  CorrespondingTable =
   Regular
     { Name = TableName "UiprmGitouchSlider"
       Properties =
