...
{
    public partial class MonitorIrshutterGraphType : ObjectGraphType<MonitorIrshutter>
    {
        public MonitorIrshutterGraphType(GESECookingContext dbContext, IDataLoaderContextAccessor dataLoaderAccessor)
        {
            Field(t => t.IrshutterMonitorId, type: typeof(GuidGraphType), nullable: False);
			...
			Field(t => t.TemperatureSource, type: typeof(ByteGraphType), nullable: False);
			Field(t => t.Dr, type: typeof(BoolGraphType), nullable: False);
			Field(t => t.Compartment, type: typeof(StringGraphType), nullable: False);
			Field(t => t.HotAmbientThreshold, type: typeof(FloatGraphType), nullable: False);
			Field(t => t.MinuteTimeout, type: typeof(IdGraphType), nullable: False);
                ...
                Field<MachineConfigurationGraphType, MachineConfiguration>("MachineConfigurations")
                    .ResolveAsync(context => 
                    {
                        var loader = dataLoaderAccessor.Context.GetOrAddCollectionBatchLoader<Guid, IEnumerable<MachineConfigurationGraphType>>(
                            "{ Name = EntityName "MonitorIrshutter"
  CorrespondingTable =
   Regular
     { Name = TableName "MonitorIrshutter"
       Properties =
  ...
  Fields =
   [{ Name = "IrshutterMonitorId"
    ...
    { Name = "Version"
      Type = Primitive Byte
      IsNullable = false }; { Name = "TemperatureSource"
                              Type = Primitive Byte
                              IsNullable = false }; { Name = "Dr"
                                                      Type = Primitive Bool
                                                      IsNullable = false };
    { Name = "Compartment"
      Type = Primitive String
      IsNullable = false }; { Name = "HotAmbientThreshold"
                              Type = Primitive Float
                              IsNullable = false }; { Name = "MinuteTimeout"
                                                      Type = Primitive Int
                                                      IsNullable = false }]
  Relations =
   [OneToMany
