...
{
    public partial class EepromUiglobalSelectorViewGraphType : ObjectGraphType<EepromUiglobalSelectorView>
    {
        public EepromUiglobalSelectorViewGraphType(GESECookingContext dbContext, IDataLoaderContextAccessor dataLoaderAccessor)
        {
			...
			Field(t => t.GlobalUimacroId, type: typeof(GuidGraphType), nullable: True);
