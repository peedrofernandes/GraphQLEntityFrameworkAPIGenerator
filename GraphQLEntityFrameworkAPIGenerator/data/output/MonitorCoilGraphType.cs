...
namespace WP.Cooking.GESE.WebAPI.GraphQL.Types
{
                ...
                Field<MachineConfigurationGraphType, MachineConfiguration>("MachineConfigurations")
                    .ResolveAsync(context => 
                    {
                        var loader = dataLoaderAccessor.Context.GetOrAddCollectionBatchLoader<Guid, IEnumerable<MachineConfigurationGraphType>>(
                            "{ Name = EntityName "MonitorCoil"
  CorrespondingTable =
   Regular
     { Name = TableName "MonitorCoil"
       Properties =
        [PrimaryKey { Type = Guid
         ...
         Primitive { Type = String
                     ...
                     IsNullable = true }; Primitive { Type = Bool
                                                      Name = "GlobalMainRelay"
                                                      IsNullable = false };
         Primitive { Type = Byte
                     Name = "StructureVersion"
                     IsNullable = false };
         Primitive { Type = Byte
                     Name = "CoilPanPresentDebounceTime"
                     IsNullable = false };
         Primitive { Type = Byte
                     Name = "CoilHotSurfaceDebounceTime"
                     IsNullable = false };
         Primitive { Type = Byte
                     Name = "MainRelayOpenDelayTime"
                     IsNullable = false };
         Primitive { Type = Byte
                     Name = "CoilPanDetectionTimeout"
                     IsNullable = false };
         Primitive { Type = Float
                     Name = "CoilHotSurfaceRaise"
                     IsNullable = false };
         Primitive { Type = Float
                     Name = "CoilHotSurfaceClear"
                     IsNullable = false };
         Primitive { Type = Float
                     Name = "CoilOvertemperatureRaise"
                     IsNullable = false };
         Primitive { Type = Float
                     Name = "CoilOvertemperatureClear"
                     IsNullable = false };
         Primitive { Type = Float
                     Name = "HeatsinkOvertemperatureRaise"
                     IsNullable = false };
         Primitive { Type = Float
                     Name = "HeatsinkOvertemperatureClear"
                     IsNullable = false };
  ...
  Fields =
   [{ Name = "MonitorCoilId"
    ...
    { Name = "GlobalMainRelay"
      Type = Primitive Bool
      IsNullable = false }; { Name = "StructureVersion"
                              Type = Primitive Byte
                              IsNullable = false };
    { Name = "CoilPanPresentDebounceTime"
      Type = Primitive Byte
      IsNullable = false }; { Name = "CoilHotSurfaceDebounceTime"
                              Type = Primitive Byte
                              IsNullable = false };
    { Name = "MainRelayOpenDelayTime"
      Type = Primitive Byte
      IsNullable = false }; { Name = "CoilPanDetectionTimeout"
                              Type = Primitive Byte
                              IsNullable = false };
    { Name = "CoilHotSurfaceRaise"
      Type = Primitive Float
      IsNullable = false }; { Name = "CoilHotSurfaceClear"
                              Type = Primitive Float
                              IsNullable = false };
    { Name = "CoilOvertemperatureRaise"
      Type = Primitive Float
      IsNullable = false }; { Name = "CoilOvertemperatureClear"
                              Type = Primitive Float
                              IsNullable = false };
    { Name = "HeatsinkOvertemperatureRaise"
      Type = Primitive Float
      IsNullable = false }; { Name = "HeatsinkOvertemperatureClear"
                              Type = Primitive Float
                              IsNullable = false }]
  Relations =
   [OneToMany
