...
{
    public partial class EepromExpansionUilowLevelInputConfigurationViewGraphType : ObjectGraphType<EepromExpansionUilowLevelInputConfigurationView>
    {
        public EepromExpansionUilowLevelInputConfigurationViewGraphType(GESECookingContext dbContext, IDataLoaderContextAccessor dataLoaderAccessor)
        {
			...
			Field(t => t.IsSafetyRelevant, type: typeof(BoolGraphType), nullable: True);
