...
{
    public partial class EepromOffuiselectorViewGraphType : ObjectGraphType<EepromOffuiselectorView>
    {
        public EepromOffuiselectorViewGraphType(GESECookingContext dbContext, IDataLoaderContextAccessor dataLoaderAccessor)
        {
			...
			Field(t => t.PhasePosition, type: typeof(ByteGraphType), nullable: True);
