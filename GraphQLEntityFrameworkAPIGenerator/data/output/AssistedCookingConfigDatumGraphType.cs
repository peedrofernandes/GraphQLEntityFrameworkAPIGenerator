...
{
    public partial class AssistedCookingConfigDatumGraphType : ObjectGraphType<AssistedCookingConfigDatum>
    {
        public AssistedCookingConfigDatumGraphType(GESECookingContext dbContext, IDataLoaderContextAccessor dataLoaderAccessor)
        {
            Field(t => t.AssistedCookingConfigId, type: typeof(GuidGraphType), nullable: False);
			...
			Field(t => t.InductanceMeasurementFrequency, type: typeof(IdGraphType), nullable: False);
            ...
            Field<IpcControllerIpcConfigurationGraphType, IpcControllerIpcConfiguration>("IpcControllerIpcConfigurations")
                .ResolveAsync(context => 
                {
                    var loader = dataLoaderAccessor.Context.GetOrAddCollectionBatchLoader<Guid, IEnumerable<IpcControllerIpcConfigurationGraphType>>(
                        "AssistedCookingConfigDatum-IpcControllerIpcConfiguration-loader",
                        async ids => 
                        {
