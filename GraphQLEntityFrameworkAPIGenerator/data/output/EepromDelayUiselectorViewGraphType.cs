...
{
    public partial class EepromDelayUiselectorViewGraphType : ObjectGraphType<EepromDelayUiselectorView>
    {
        public EepromDelayUiselectorViewGraphType(GESECookingContext dbContext, IDataLoaderContextAccessor dataLoaderAccessor)
        {
