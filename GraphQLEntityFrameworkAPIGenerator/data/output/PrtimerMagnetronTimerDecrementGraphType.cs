...
{
    public partial class PrtimerMagnetronTimerDecrementGraphType : ObjectGraphType<PrtimerMagnetronTimerDecrement>
    {
        public PrtimerMagnetronTimerDecrementGraphType(GESECookingContext dbContext, IDataLoaderContextAccessor dataLoaderAccessor)
        {
            Field(t => t.PrtimerMagnetronTimerDecrementId, type: typeof(GuidGraphType), nullable: False);
            ...
            Field<PowerReductionTimerConfigurationGraphType, PowerReductionTimerConfiguration>("PowerReductionTimerConfigurations")
                .ResolveAsync(context => 
                {
                    var loader = dataLoaderAccessor.Context.GetOrAddCollectionBatchLoader<Guid, IEnumerable<PowerReductionTimerConfigurationGraphType>>(
                        "PrtimerMagnetronTimerDecrement-PowerReductionTimerConfiguration-loader",
                        async ids => 
                        {
