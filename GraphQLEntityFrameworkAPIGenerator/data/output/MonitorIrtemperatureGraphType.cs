...
{
    public partial class MonitorIrtemperatureGraphType : ObjectGraphType<MonitorIrtemperature>
    {
        public MonitorIrtemperatureGraphType(GESECookingContext dbContext, IDataLoaderContextAccessor dataLoaderAccessor)
        {
            Field(t => t.IrtemperatureMonitorId, type: typeof(GuidGraphType), nullable: False);
			...
			Field(t => t.MinimumObjectSize, type: typeof(IdGraphType), nullable: False);
			Field(t => t.CavityTempCompSlope, type: typeof(FloatGraphType), nullable: False);
			Field(t => t.CavityTempCompBias, type: typeof(FloatGraphType), nullable: False);
			Field(t => t.ClassificationMargin, type: typeof(FloatGraphType), nullable: False);
			Field(t => t.MinimumTemperatureThold, type: typeof(FloatGraphType), nullable: False);
			Field(t => t.Section, type: typeof(ByteGraphType), nullable: False);
                ...
                Field<MachineConfigurationGraphType, MachineConfiguration>("MachineConfigurations")
                    .ResolveAsync(context => 
                    {
                        var loader = dataLoaderAccessor.Context.GetOrAddCollectionBatchLoader<Guid, IEnumerable<MachineConfigurationGraphType>>(
                            "{ Name = EntityName "MonitorIrtemperature"
  CorrespondingTable =
   Regular
     { Name = TableName "MonitorIrtemperature"
       Properties =
        [PrimaryKey { Type = Guid
         ...
         Primitive { Type = Float
                     Name = "CavityTempCompSlope"
                     IsNullable = false };
         Primitive { Type = Float
                     Name = "CavityTempCompBias"
                     IsNullable = false };
         Primitive { Type = Float
                     Name = "ClassificationMargin"
                     IsNullable = false };
         Primitive { Type = Float
                     Name = "MinimumTemperatureThold"
                     IsNullable = false }; Primitive { Type = Byte
                                                       Name = "Section"
                                                       IsNullable = false };
  ...
  Fields =
   [{ Name = "IrtemperatureMonitorId"
    ...
    { Name = "MinimumObjectSize"
      Type = Primitive Int
      IsNullable = false }; { Name = "CavityTempCompSlope"
                              Type = Primitive Float
                              IsNullable = false };
    { Name = "CavityTempCompBias"
      Type = Primitive Float
      IsNullable = false }; { Name = "ClassificationMargin"
                              Type = Primitive Float
                              IsNullable = false };
    { Name = "MinimumTemperatureThold"
      Type = Primitive Float
      IsNullable = false }; { Name = "Section"
                              Type = Primitive Byte
                              IsNullable = false }]
  Relations =
   [OneToMany
