...
{
    public partial class HmiAvailableNodeGraphType : ObjectGraphType<HmiAvailableNode>
    {
        public HmiAvailableNodeGraphType(GESECookingContext dbContext, IDataLoaderContextAccessor dataLoaderAccessor)
        {
                ...
                Field<DisplayGraphType, Display>("Displays")
                    .ResolveAsync(context => 
                    {
                        var loader = dataLoaderAccessor.Context.GetOrAddCollectionBatchLoader<Guid, IEnumerable<DisplayGraphType>>(
                            "{ Name = EntityName "HmiAvailableNode"
  CorrespondingTable =
   Regular
     { Name = TableName "HmiAvailableNode"
       Properties =
