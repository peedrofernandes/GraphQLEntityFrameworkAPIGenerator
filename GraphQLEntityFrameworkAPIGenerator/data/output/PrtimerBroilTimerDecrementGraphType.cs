...
{
    public partial class PrtimerBroilTimerDecrementGraphType : ObjectGraphType<PrtimerBroilTimerDecrement>
    {
        public PrtimerBroilTimerDecrementGraphType(GESECookingContext dbContext, IDataLoaderContextAccessor dataLoaderAccessor)
        {
            Field(t => t.PrtimerBroilTimerDecrementId, type: typeof(GuidGraphType), nullable: False);
            ...
            Field<PowerReductionTimerConfigurationGraphType, PowerReductionTimerConfiguration>("PowerReductionTimerConfigurations")
                .ResolveAsync(context => 
                {
                    var loader = dataLoaderAccessor.Context.GetOrAddCollectionBatchLoader<Guid, IEnumerable<PowerReductionTimerConfigurationGraphType>>(
                        "PrtimerBroilTimerDecrement-PowerReductionTimerConfiguration-loader",
                        async ids => 
                        {
