...
namespace WP.Cooking.GESE.WebAPI.GraphQL.Types
{
    public partial class CycleOptionsFullViewGraphType : ObjectGraphType<CycleOptionsFullView>
    {
        public CycleOptionsFullViewGraphType(GESECookingContext dbContext, IDataLoaderContextAccessor dataLoaderAccessor)
        {
			...
			Field(t => t.AmountDisplayUnitsId, type: typeof(ByteGraphType), nullable: True);
			...
			Field(t => t.ResultingAttributeId, type: typeof(ByteGraphType), nullable: True);
			...
			Field(t => t.CycleOptionsPrmStepsConfigId, type: typeof(GuidGraphType), nullable: True);
			...
			Field(t => t.MwoPowerLevelsList, type: typeof(ListGraphType<ByteGraphType>), nullable: True);
			...
			Field(t => t.FoodTypeOptions, type: typeof(ListGraphType<ByteGraphType>), nullable: True);
