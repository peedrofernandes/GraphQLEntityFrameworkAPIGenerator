...
{
    public partial class EepromUicycleSelectorViewGraphType : ObjectGraphType<EepromUicycleSelectorView>
    {
        public EepromUicycleSelectorViewGraphType(GESECookingContext dbContext, IDataLoaderContextAccessor dataLoaderAccessor)
        {
