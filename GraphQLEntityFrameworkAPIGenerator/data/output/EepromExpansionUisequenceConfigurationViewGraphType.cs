...
{
    public partial class EepromExpansionUisequenceConfigurationViewGraphType : ObjectGraphType<EepromExpansionUisequenceConfigurationView>
    {
        public EepromExpansionUisequenceConfigurationViewGraphType(GESECookingContext dbContext, IDataLoaderContextAccessor dataLoaderAccessor)
        {
			...
			Field(t => t.StepIndex, type: typeof(ByteGraphType), nullable: False);
			Field(t => t.StepDescription, type: typeof(StringGraphType), nullable: False);
			...
			Field(t => t.UiconditionId, type: typeof(GuidGraphType), nullable: True);
			Field(t => t.ConditionIndex, type: typeof(ByteGraphType), nullable: True);
			Field(t => t.ConditionGireadTypeId, type: typeof(ByteGraphType), nullable: True);
