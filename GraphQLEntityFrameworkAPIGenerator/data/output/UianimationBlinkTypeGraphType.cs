...
{
    public partial class UianimationBlinkTypeGraphType : ObjectGraphType<UianimationBlinkType>
    {
        public UianimationBlinkTypeGraphType(GESECookingContext dbContext, IDataLoaderContextAccessor dataLoaderAccessor)
        {
			...
			Field(t => t.DutyCycle, type: typeof(ByteGraphType), nullable: False);
            ...
            Field<UianimationDetailGraphType, UianimationDetail>("UianimationDetails")
                .ResolveAsync(context => 
                {
                    var loader = dataLoaderAccessor.Context.GetOrAddCollectionBatchLoader<Guid, IEnumerable<UianimationDetailGraphType>>(
                        "UianimationBlinkType-UianimationDetail-loader",
                        async ids => 
                        {
