...
{
    public partial class UiprmGiincrementalEncoderGraphType : ObjectGraphType<UiprmGiincrementalEncoder>
    {
        public UiprmGiincrementalEncoderGraphType(GESECookingContext dbContext, IDataLoaderContextAccessor dataLoaderAccessor)
        {
            Field(t => t.Id, type: typeof(GuidGraphType), nullable: False);
			Field(t => t.Description, type: typeof(StringGraphType), nullable: False);
			Field(t => t.PulseCountTimeout, type: typeof(ByteGraphType), nullable: False);
			Field(t => t.ToIncreasePulseNumber, type: typeof(ByteGraphType), nullable: False);
                ...
                Field<TableTargetGraphType, TableTarget>("TableTargets")
                    .ResolveAsync(context => 
                    {
                        var loader = dataLoaderAccessor.Context.GetOrAddCollectionBatchLoader<byte, TableTargetGraphType>(
                            "{ Name = EntityName "UiprmGiincrementalEncoder"
  CorrespondingTable =
   Regular
     { Name = TableName "UiprmGiincrementalEncoder"
       Properties =
        [PrimaryKey { Type = Guid
                      ...
                      IsNullable = false }; Primitive { Type = String
                                                        ...
                                                        IsNullable = false };
         Primitive { Type = Byte
                     Name = "PulseCountTimeout"
                     IsNullable = false };
         Primitive { Type = Byte
                     Name = "ToIncreasePulseNumber"
                     IsNullable = false }; Primitive { Type = String
                                                       Name = "Owner"
                                                       IsNullable = false };
         Primitive { Type = Byte
  ...
  Fields =
   [{ Name = "Id"
      ...
      IsNullable = false }; { Name = "Description"
                              ...
                              IsNullable = false }; { Name = "PulseCountTimeout"
                                                      Type = Primitive Byte
                                                      IsNullable = false };
    { Name = "ToIncreasePulseNumber"
      Type = Primitive Byte
