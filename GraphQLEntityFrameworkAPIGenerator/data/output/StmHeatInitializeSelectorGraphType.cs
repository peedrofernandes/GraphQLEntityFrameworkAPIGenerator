...
{
    public partial class StmHeatInitializeSelectorGraphType : ObjectGraphType<StmHeatInitializeSelector>
    {
        public StmHeatInitializeSelectorGraphType(GESECookingContext dbContext, IDataLoaderContextAccessor dataLoaderAccessor)
        {
            ...
            Field<HeatInitializeGraphType, HeatInitialize>("HeatInitializes")
                .ResolveAsync(context => 
                {
                    var loader = dataLoaderAccessor.Context.GetOrAddCollectionBatchLoader<Guid, HeatInitializeGraphType>(
                        "StmHeatInitializeSelector-HeatInitialize-loader",
                        async ids => 
                        {
