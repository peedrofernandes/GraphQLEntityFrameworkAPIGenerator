...
{
    public partial class SrstuckProbeCheckParameterGraphType : ObjectGraphType<SrstuckProbeCheckParameter>
    {
        public SrstuckProbeCheckParameterGraphType(GESECookingContext dbContext, IDataLoaderContextAccessor dataLoaderAccessor)
        {
            Field(t => t.SrStuckProbeCheckParamsId, type: typeof(GuidGraphType), nullable: False);
			...
			Field(t => t.VarianceThreshold, type: typeof(ByteGraphType), nullable: False);
			Field(t => t.DebounceThreshold, type: typeof(ByteGraphType), nullable: False);
			Field(t => t.BakeAmperes, type: typeof(ByteGraphType), nullable: False);
			Field(t => t.Broil1Amperes, type: typeof(ByteGraphType), nullable: False);
			Field(t => t.Broil2Amperes, type: typeof(ByteGraphType), nullable: False);
			Field(t => t.ConvectRing1Amperes, type: typeof(ByteGraphType), nullable: False);
			Field(t => t.ConvectRing2Amperes, type: typeof(ByteGraphType), nullable: False);
			Field(t => t.TotalAmpereThreshold, type: typeof(IdGraphType), nullable: False);
                ...
                Field<SrsafetyRelevantParameterGraphType, SrsafetyRelevantParameter>("SrsafetyRelevantParameters")
                    .ResolveAsync(context => 
                    {
                        var loader = dataLoaderAccessor.Context.GetOrAddCollectionBatchLoader<Guid, IEnumerable<SrsafetyRelevantParameterGraphType>>(
                            "{ Name = EntityName "SrstuckProbeCheckParameter"
  CorrespondingTable =
   Regular
  ...
  Fields =
   [{ Name = "SrStuckProbeCheckParamsId"
    ...
    { Name = "Version"
      Type = Primitive Byte
      IsNullable = false }; { Name = "VarianceThreshold"
                              Type = Primitive Byte
                              IsNullable = false }; { Name = "DebounceThreshold"
                                                      Type = Primitive Byte
                                                      IsNullable = false };
    { Name = "BakeAmperes"
      Type = Primitive Byte
      IsNullable = false }; { Name = "Broil1Amperes"
                              Type = Primitive Byte
                              IsNullable = false }; { Name = "Broil2Amperes"
                                                      Type = Primitive Byte
                                                      IsNullable = false };
    { Name = "ConvectRing1Amperes"
      Type = Primitive Byte
      IsNullable = false }; { Name = "ConvectRing2Amperes"
                              Type = Primitive Byte
                              IsNullable = false };
    { Name = "TotalAmpereThreshold"
      Type = Primitive Int
