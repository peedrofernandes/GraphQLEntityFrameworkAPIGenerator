...
{
    public partial class CycleTimeOptionsSelectionBehaviorLabelGraphType : ObjectGraphType<CycleTimeOptionsSelectionBehaviorLabel>
    {
        public CycleTimeOptionsSelectionBehaviorLabelGraphType(GESECookingContext dbContext, IDataLoaderContextAccessor dataLoaderAccessor)
        {
            ...
            Field<CycleOptionsPrmTimeGraphType, CycleOptionsPrmTime>("CycleOptionsPrmTimes")
                .ResolveAsync(context => 
                {
                    var loader = dataLoaderAccessor.Context.GetOrAddCollectionBatchLoader<Guid, IEnumerable<CycleOptionsPrmTimeGraphType>>(
                        "CycleTimeOptionsSelectionBehaviorLabel-CycleOptionsPrmTime-loader",
                        async ids => 
                        {
